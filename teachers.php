...
<!-- Flower image -->
            <div class="col-md-4" id="flower">
                <img src="images/slider-16.jpg" class="img-responsive img-circle" alt="Urban calm logo">
            </div> 
          </div>
            </div> 
        </div>
        ...
        <div class="row" id="about-header">
          <div class="col-md-10 col-md-offset-1 header">
            ...
            <p>I am a practising naturopath, massage and bodywork therapist and have had my clinic in Moray 
              ...
              <p>Urban Calm is a beautiful sanctuary, an oasis to come and drink of whatever it is that we desire or 
...
<!-- Flower image -->
        ...
        <div class="row" id="about-header">
          ...
          <div class="col-md-4" id="flower">
            ...
            <div class="col-md-8">
            <p>UC is very fortunate to have Sahsa practicing Karma Yoga here at the centre</p>
