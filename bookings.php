          ...
          <div class="col-md-10 col-md-offset-1 header hidden-xs">
            ...
            <p><button type="button" class="visible-xs btn btn-default btn-lg center-block" style="margin-top: 5%;">BOOK NOW</button></p>
              ...
              <hr>
                ...
                address ).</p>
                <p><b class="light">2.</b> Click on the 'Classes' tab</p>
                <p><b class="light">3.</b> Click the ‘sign up now!’ link next to the class you would like to attend</p>
                <p><b class="light">4.</b> Click 'Make a Single Reservation'</p>
